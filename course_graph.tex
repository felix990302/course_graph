...
\begin{tikzpicture}[remember picture, overlay, font=\small]
    ...
    \PlaceCourses{CS365/cs/10cm, CO444/co/10.5cm, CS467/cs/1cm, PMATH467/pm/1cm}

    \node[term, below=of W21, alias=last] (S21) {Spring 21};
    \PlaceCourses{CO446/co/19cm}

    \node[term, below=of S21, alias=last] (F21) {Fall 21};
    \PlaceCourses{CS451/cs override/8.5cm, CS370/cs/1cm, CO442/co/2.5cm, CO456/co/1cm}

    \node[term, below=of F21, alias=last] (W22) {Winter 22};

    \node[term, below=of W22, alias=last] (S22) {Spring 22};
    \PlaceCourses{CS466/cs co/1cm, CS486/cs/1cm, PMATH450/pm/21.5cm, PHYS234/cs/1cm}
