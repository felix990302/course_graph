...
\begin{tikzpicture}[remember picture, overlay, font=\small]
    ...
    \PlaceCourses{CS762/cs/1cm, CS350/cs/3cm, PMATH347/co pm/14.5cm, PMATH450/pm/2cm}
    ...
    \PlaceCourses{CS370/cs/12cm, CO442/co/2.5cm, CO456/co/1cm, PMATH453/pm/5.5cm}

    \node[term, below=of F21, alias=last] (W22) {Winter 22};

    \node[term, below=of W22, alias=last] (S22) {Spring 22};
    \PlaceCourses{CS466/cs co/1cm, CS486/cs/1cm, PMATH352/pm/21.5cm, PHYS234/cs/1cm}
