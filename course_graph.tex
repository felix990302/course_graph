...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[node distance=6cm]
        ...
        \begin{scope}[node distance=12cm]
            ...
            \foreach \title/\style in {CO481/co,PD?/cs} {
                \node (\title) [\style,right of=last,alias=last,anchor=west] {\title};
            }
        ...
        \foreach \title/\style in {PMATH348/co pm,CO487/cs co,CS444/cs,CS365/cs co,PHYS121/cs} {
            \node (\title) [\style,right of=last,alias=last,anchor=west] {\title};
        }
        ...
        \foreach \title/\style in {CS499R/cs,CS485/cs,CS452/cs,CS462/cs co} {
            \node (\title) [\style,right of=last,alias=last,anchor=west] {\title};
        }
        ...
        \foreach \title/\style in {PHYS234/cs,CS466/cs,CS499T/cs,CS370/cs} {
            \node (\title) [\style,right of=last,alias=last,anchor=west] {\title};
        }
        ...
        \draw[prereq] (CS370) to [bend right=5] (MATH148);
