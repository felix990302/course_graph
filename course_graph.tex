...
\begin{tikzpicture}[remember picture, overlay]
    ...
    \PlaceCourses{CS245/cs/3cm, CS246E/cs/3cm, CS251/cs/3cm, MATH249/cs/3cm, MATH245/cs/3cm}
    ...
    \PlaceCourses{CS762/cs/7cm, CS350/cs/1cm, PMATH347/co pm/10.5cm, PMATH352/co pm/1cm}
    ...
    \PlaceCourses{CS466/cs/3cm, CS370/cs/5cm, CO450/co/1cm, CO442/co/1cm}

    \node[term, below=of F21, alias=last] (W22) {Winter 22};

    \node[term, below=of W22, alias=last] (S22) {Spring 22};
    \PlaceCourses{CS451/cs/9cm, CS99T/cs/3cm, PHYS234/cs/5cm}
