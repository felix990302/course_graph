...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[node distance=6cm]
        ...
        \begin{scope}[node distance=12cm]
            ...
            \foreach \title/\style in {CS466/cs} {
                \node (\title) [\style,right of=last,alias=last,anchor=west] {\title};
            }
        ...
        \foreach \title/\style in {PMATH347/co pm,CS350/cs,PMATH352/co pm,CS762/cs,CO446/co} {
            \node (\title) [\style,right of=last,alias=last,anchor=west] {\title};
        }
        ...
        \foreach \title/\style in {CO481/co,CS370/cs,CS485/cs,CS452/cs,CS462/cs co} {
            \node (\title) [\style,right of=last,alias=last,anchor=west] {\title};
        }

        \draw[prereq] (CS452) -- (CS350);
        \draw[prereq] (CS370) to [bend right=5] (CS246E);
