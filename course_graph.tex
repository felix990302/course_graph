...
\begin{tikzpicture}[remember picture, overlay]
    ...
    \PlaceCourses{CS499T/cs/6cm, CO450/co/6cm, CO442/co/1cm}

    \node[term, below=of F21, alias=last] (W22) {Winter 22};

    \node[term, below=of W22, alias=last] (S22) {Spring 22};
    \PlaceCourses{CS466/cs co/3cm, CS451/cs/3cm, CS370/cs/1cm, PHYS234/cs/8cm}
    ...
    \begin{scope}[on background layer]
        \graph[use existing nodes, simple] {
            ...
            CS485 <-[prereq] CS341;
            CS485 <-[prereq, dotted] STAT230;
            CS365 <-[prereq] CS240E;
            CS365 <-[prereq, dotted] {CS241, MATH249};
            ...
            CS370 <-[prereq, dotted] {MATH146, MATH148, CS246E};
