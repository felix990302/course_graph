...
\begin{tikzpicture}[remember picture, overlay, font=\small]
    ...
    \PlaceCourses{STAT230/cs/1cm, CS146/cs/1cm, MATH146/cs/10cm, MATH148/cs/5.5cm, AFM102/cs/1cm, PD1/cs/1cm}
    ...
    \PlaceCourses{CS245/cs cm/4cm, CS246E/cs cm/1cm, CS251/cs/1cm, MATH249/cs co/1cm, MATH245/cs/5cm}

    \node[term, below=of F18, alias=last] (W19) {Winter 19};
    \PlaceCourses{STAT241/cs/1cm, CS240E/cs cm/1cm, CS241/cs cm/4cm, MATH247/cs pm/11.5cm, PMATH340/co pm/4.5cm}
    ...
    \PlaceCourses{CS341/cs cm/3cm, CO351/cm co override/8.5cm, CO342/co/1cm, CO255/cm co/1cm, PMATH351/co pm/5cm}
    ...
    \PutCourses{PD?/cs/below/2.75cm of PD6, CO456/cm co/left/10.5cm of last}

    \node[term, below=of F20, alias=last] (W21) {Winter 21};
    \PlaceCourses{CS365/cs/11cm, CO444/co/9.5cm, CO481/co/1cm, PMATH467/pm/1cm}

    \node[term, below=of W21, alias=last] (S21) {Spring 21};
    \PlaceCourses{CO446/co/16cm}

    \node[term, below=of S21, alias=last] (F21) {Fall 21};
    \PlaceCourses{CS480/cs/4cm, CS371/cs cm/3.5cm, CO450/cm co/1.5cm, CO442/co/1cm}

    \node[term, below=of F21, alias=last] (W22) {Winter 22};

    \node[term, below=of W22, alias=last] (S22) {Spring 22};
    \PlaceCourses{CS466/cs co/1cm, CS451/cs override/3cm, CS475/cs cm/1cm, PHYS234/cs cm/19.5cm}
