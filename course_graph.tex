...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[node distance=6cm]
        ...
        \begin{scope}[node distance=12cm]
            \node[term,alias=last,anchor=west] (WT1) at (0, -6) {WT1};
            \foreach \title/\style in {PD11/cs,PHYS122/cs} {
                \node (\title) [\style,right of=last,alias=last,anchor=west] {\title};
            }

            \node[term,alias=last,anchor=west] (WT2) at (0, -15) {WT2};
            \foreach \title/\style in {ENGL109/cs,PD10/cs} {
                \node (\title) [\style,right of=last,alias=last,anchor=west] {\title};
            }

            \node[term,alias=last,anchor=west] (WT3) at (0, -21) {WT3};
            \foreach \title/\style in {PHYS121/cs,PD?/cs} {
                \node (\title) [\style,right of=last,alias=last,anchor=west] {\title};
            }
            
            \node[term,alias=last,anchor=west] (WT4) at (0, -27) {WT4};
            \foreach \title/\style in {CO456/co,PD?/cs} {
                \node (\title) [\style,right of=last,alias=last,anchor=west] {\title};
            }

            \node[term,alias=last,anchor=west] (WT5) at (0, -33) {WT5};
            \foreach \title/\style in {PMATH352/co pm} {
                \node (\title) [\style,right of=last,alias=last,anchor=west] {\title};
            }

            \node[term,alias=last,anchor=west] (WT6) at (0, -36) {WT6};
        ...
        \node[term,alias=last,anchor=west] (2A) at (0, -9) {2A};
        ...
        \node[term,alias=last,anchor=west] (2B) at (0, -12) {2B};
        ...
        \node[term,alias=last,anchor=west] (3A) at (0, -18) {3A};
        ...
        \node[term,alias=last,anchor=west] (3B) at (0, -24) {3B};
        ...
        \node[term,alias=last,anchor=west] (4A) at (0, -30) {4A};
        \foreach \title/\style in {PMATH348/co pm,PMATH450/pm,CS444/cs,CS365/cs co,PHYS234/cs} {
            \node (\title) [\style,right of=last,alias=last,anchor=west] {\title};
        }

        \draw[prereq] (PMATH348) -- (PMATH347);
        \draw[prereq] (PMATH450) -- (PMATH347);
        \draw[prereq] (PMATH450) to [bend left=5] (PMATH351);
        ...
        \draw[prereq] (PMATH352) to [bend left=45] (MATH247);

        \node[term,alias=last,anchor=west] (4B) at (0, -39) {4B};
        \foreach \title/\style in {CO481/co,CS343/cs,CS485/cs,CS452/cs,CS462/cs co} {
            \node (\title) [\style,right of=last,alias=last,anchor=west] {\title};
        }

        \draw[prereq] (CS452) -- (CS350);
        \draw[prereq] (CS343) to [bend right=30] (CS350);
        ...
        \node[term,alias=last,anchor=west] (5A) at (0, -42) {5A};
        \foreach \title/\style in {CS499/cs,CS466/cs co,CS371/cs} {
            \node (\title) [\style,right of=last,alias=last,anchor=west] {\title};
        }

        \draw[prereq] (CS466) -- (CS341);
        \draw[prereq] (CS371) to [bend right=10] (CS146);
        \draw[prereq] (CS371) -- (MATH245);
