...
\begin{tikzpicture}[remember picture, overlay, font=\small]
    ...
    \PlaceCourses{CS365/cs/9cm, CO754/co/11.5cm, CS467/cs/1cm, CO463/co/3cm}
    ...
    \PlaceCourses{CS480/cs/4cm, CS370/cs/5.5cm, ENGL210F/cs/10.5cm, CO444/co/1cm, PHYS233/cs/1cm}
    ...
    \begin{scope}[on background layer]
        \graph[use existing nodes, simple] {
            ...
            CO463 <-[prereq, dashed] {CO255, PMATH351};
