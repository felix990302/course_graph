...
\begin{tikzpicture}[remember picture, overlay]
    ...
    \PlaceCourses{CS145/cs/1cm, MATH145/cs/10cm, MATH147/cs/6cm, AFM101/cs/3cm, AFM131/cs/1cm}

    \node[term, below=of F17, alias=last] (W18) {Winter 18};
    \PlaceCourses{CS146/cs/3cm, STAT230/cs/1cm, MATH146/cs/8cm, MATH148/cs/2.25cm, AFM102/cs/3cm, PD1/cs/1cm}
    ...
    \PlaceCourses{CS245/cs/1cm, CS246E/cs/4cm, CS251/cs/1cm, MATH249/cs co/1cm, MATH245/cs/1cm}

    \node[term, below=of F18, alias=last] (W19) {Winter 19};
    \PlaceCourses{CS240E/cs/4cm, CS241/cs/4cm, PMATH340/co pm/4cm, MATH247/cs pm/4cm, STAT241/cs/5cm}
    ...
    \PlaceCourses{CS341/cs/1cm, CO342/co/10cm, CO351/co override/1cm, CO255/co/1cm, PMATH351/pm/4.25cm}
    ...
    \PlaceCourses{CS762/cs/5cm, CS350/cs/5cm, PMATH347/co pm/9cm, PMATH352/pm/1cm}

    \node[term, below=of S20, alias=last] (F20) {Fall 20};
    \PutCourses{PD?/cs/below/2.75cm of PD6, CO456/co/left/8cm of last}

    \node[term, below=of F20, alias=last] (W21) {Winter 21};
    \PlaceCourses{CS485/cs/3cm, CS365/cs/2cm, PMATH348/co pm/14cm, CO481/co/1cm}

    \node[term, below=of W21, alias=last] (S21) {Spring 21};
    \PlaceCourses{CO446/co/19cm}

    \node[term, below=of S21, alias=last] (F21) {Fall 21};
    \PlaceCourses{CS499T/cs/3cm, CO442/co/11.75cm, CO450/co/1cm}

    \node[term, below=of F21, alias=last] (W22) {Winter 22};

    \node[term, below=of W22, alias=last] (S22) {Spring 22};
    \PlaceCourses{CS466/cs co/1cm, CS451/cs override/5.25cm, CS370/cs/1cm, PHYS234/cs/16.25cm}
