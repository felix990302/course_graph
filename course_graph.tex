...
\begin{tikzpicture}[remember picture, overlay, font=\small]
    ...
    \PlaceCourses{CS466/cs co/1cm, CS370/cs/8.5cm, CO442/co/2.5cm, CO456/co/1cm}

    \node[term, below=of F21, alias=last] (W22) {Winter 22};

    \node[term, below=of W22, alias=last] (S22) {Spring 22};
    \PlaceCourses{CS486/cs/4.5cm, CS451/cs override/1cm, PMATH450/pm/18cm, PHYS234/cs/1cm}
