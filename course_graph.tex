...
\begin{tikzpicture}[remember picture, overlay, font=\small]
  \node[term, xshift=3.5cm, yshift=-2.25cm, alias=last] (AP) at (current page.north west) {AP Credits};
    ...
    \PutCourses{PD13/cs/below/1cm of CO463, CO471/co/left/10cm of last}

    \node[term, below=of S21, alias=last] (F21) {Fall 21};
    \PlaceCourses{PMATH453/pm/28.5cm}

    \node[term, below=of F21, alias=last] (W22) {Winter 22};
    \PlaceCourses{CS480/cs/4cm, CS370/cs/5.5cm, ENGL210F/cs/14cm, PHYS233/cs/1cm}
