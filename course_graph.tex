...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[node distance=2cm]
        ...
        \begin{scope}[node distance=4cm]
            ...
            \foreach \title/\style in {PMATH351/co pm} {
                \node (\title) [\style,right of=last,alias=last,anchor=west] {\title};
            }
        ...
        \draw[prereq] (PMATH347) to [bend left=75] (MATH245);
        ...
        \foreach \title/\style in {PMATH352/co pm,CS350/cs,CS486/cs,CS762/cs,CO446/co} {
            \node (\title) [\style,right of=last,alias=last,anchor=west] {\title};
        }

        \draw[prereq] (PMATH352) .. controls (PHYS121.west) and (ENGL109.west) .. (MATH247);
        \draw[prereq] (CS350) -- (CS240E);
        \draw[prereq] (CS350) .. controls (CO342.west) .. (CS241);
