...
\begin{tikzpicture}[remember picture, overlay, font=\small]
    ...
    \PlaceCourses{CS365/cs/9cm, CO463/co/11.5cm, CS467/cs/1cm, PMATH343/pm/3cm}

    \node[term, below=of W21, alias=last] (S21) {Spring 21};
    \PlaceCourses{CO471/co/18.5cm}
    ...
    \PlaceCourses{CS480/cs/4cm, CS370/cs/5.5cm, ENGL210F/cs/10.5cm, PMATH352/pm/1cm, PHYS233/cs/1cm}
