...
\begin{tikzpicture}[remember picture, overlay, font=\small]
    ...
    \PlaceCourses{CS146/cs/4cm, STAT230/cs/1cm, MATH146/cs/7cm, MATH148/cs/5.5cm, AFM102/cs/1cm, PD1/cs/1cm}
    ...
    \PlaceCourses{CS245/cs cm/1cm, CS246E/cs cm/4cm, CS251/cs/1cm, MATH249/cs co/1cm, MATH245/cs/4cm}
    ...
    \PutCourses{PD6/cs/below/3cm of PD10, PHYS121/cs cm/left/1cm of last}

    \node[term, below=of W20, alias=last] (S20) {Spring 20};
    \PlaceCourses{CS762/cs/1cm, CS350/cs/3cm, PMATH347/co pm/16cm, PMATH352/pm/1cm}

    \node[term, below=of S20, alias=last] (F20) {Fall 20};
    \PutCourses{PD?/cs/below/3cm of PD6, CO456/cm co/left/8.5cm of last}

    \node[term, below=of F20, alias=last] (W21) {Winter 21};
    \PlaceCourses{CS365/cs/11cm, PMATH467/pm/11.5cm, CO481/co/1cm}
