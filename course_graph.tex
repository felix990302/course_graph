...
\begin{tikzpicture}[remember picture, overlay, font=\small]
    ...
    \PutCourses{PD?/cs/below/2.75cm of PD6, CO456/co/left/10.5cm of last}
    ...
    \PlaceCourses{CS486/cs/4cm, CS451/cs override/1cm, CO450/co/4cm, CO442/co/1cm}

    \node[term, below=of F21, alias=last] (W22) {Winter 22};

    \node[term, below=of W22, alias=last] (S22) {Spring 22};
    \PlaceCourses{CS466/cs co/1cm, CS370/cs/6.5cm, PMATH450/pm/16cm, PHYS234/cs/1cm}
