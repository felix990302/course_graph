...
\begin{tikzpicture}[remember picture, overlay]
    ...
    \PlaceCourses{CS245/cs/1cm, CS246E/cs/4cm, CS251/cs/1cm, MATH249/cs co/1cm, MATH245/cs/3.25cm}

    \node[term, below=of F18, alias=last] (W19) {Winter 19};
    \PlaceCourses{CS240E/cs/4cm, CS241/cs/4cm, PMATH340/co pm/5cm, MATH247/cs pm/3.5cm, STAT241/cs/4.75cm}
    ...
    \PlaceCourses{CS341/cs/4cm, CO351/co override/7cm, CO342/co/1cm, CO255/co/1cm, PMATH351/pm/4.5cm}
    ...
    \PlaceCourses{CS762/cs/1cm, CS350/cs/8cm, PMATH347/co pm/10.25cm, PMATH352/pm/1cm}

    \node[term, below=of S20, alias=last] (F20) {Fall 20};
    \PutCourses{PD?/cs/below/2.75cm of PD6, CO456/co/left/8.25cm of last}

    \node[term, below=of F20, alias=last] (W21) {Winter 21};
    \PlaceCourses{CS485/cs/4cm, CS365/cs/1cm, PMATH348/co pm/14.25cm, CO481/co/1cm}

    \node[term, below=of W21, alias=last] (S21) {Spring 21};
    \PlaceCourses{CO446/co/21.5cm}

    \node[term, below=of S21, alias=last] (F21) {Fall 21};
    \PlaceCourses{CS499T/cs/4cm, CO450/co/7cm, CO442/co/1cm}

    \node[term, below=of F21, alias=last] (W22) {Winter 22};

    \node[term, below=of W22, alias=last] (S22) {Spring 22};
    \PlaceCourses{CS466/cs co/1cm, CS451/cs override/4cm, CS370/cs/1cm, PHYS234/cs/18cm}
    ...
    \begin{scope}[on background layer]
        \graph[use existing nodes, simple] {
            ...
            CS365 <-[prereq] CS240E;
            CS365 <-[prereq, dashed] {CS241, MATH249};
            ...
            CS370 <-[prereq, dashed] {MATH146, MATH148, CS246E};
