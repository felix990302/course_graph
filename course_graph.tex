...
\begin{tikzpicture}[remember picture, overlay]
    ...
    \PlaceCourses{CS245/cs/3cm, CS246E/cs/2cm, CS251/cs/2cm, MATH249/cs/6cm, MATH245/cs/2cm}

    \node[term, below=of F18, alias=last] (W19) {Winter 19};
    \PlaceCourses{CS240E/cs/5cm, CS241/cs/3cm, PMATH340/co pm/3cm, MATH247/cs/2cm, STAT241/cs/6cm}
    ...
    \PlaceCourses{CS341/cs/3cm, CO342/co/8cm, CO351/co override/1cm, CO255/co/1cm, PMATH351/pm/6cm}
    ...
    \PlaceCourses{CS762/cs/5cm, CS350/cs/3cm, PMATH347/co pm/7cm, PMATH352/co pm/1cm}

    \node[term, below=of S20, alias=last] (F20) {Fall 20};
    \PutCourses{PD?/cs/below/2.75cm of PD6, CO456/co/left/1cm of last}
