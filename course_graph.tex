...
\begin{tikzpicture}[remember picture, overlay, font=\small]
    ...
    \PlaceCourses{CS341/cs/3cm, CO351/co override/8.5cm, CO342/co/1cm, CO255/co/1cm, PMATH351/co pm/5cm}
    ...
    \PutCourses{PD?/cs/below/2.75cm of PD6, CO456/co/left/10cm of last}

    \node[term, below=of F20, alias=last] (W21) {Winter 21};
    \PlaceCourses{CS365/cs/11cm, CO444/co/9.5cm, CS467/cs/1cm, PMATH467/pm/1cm}

    \node[term, below=of W21, alias=last] (S21) {Spring 21};
    \PlaceCourses{PMATH450/pm/28.5cm}

    \node[term, below=of S21, alias=last] (F21) {Fall 21};
    \PlaceCourses{CS451/cs override/6.5cm, CO450/co/5cm, CO442/co/1cm, PMATH453/pm/8cm}

    \node[term, below=of F21, alias=last] (W22) {Winter 22};

    \node[term, below=of W22, alias=last] (S22) {Spring 22};
    \PlaceCourses{CS466/cs co/1cm, CS486/cs/1cm, CS370/cs/3cm, PHYS234/cs/19.5cm}
    ...
    \begin{scope}[on background layer]
        \graph[use existing nodes, simple] {
            ...
            PMATH467 <-[prereq, dotted] PMATH347;
            PMATH467 <-[prereq, dashed] PMATH351;
            CS467 <-[prereq, dashed] MATH245;

            PMATH450 <-[prereq] PMATH351;

            CS451 <-[prereq] {CS341, CS350};
            CO442 <-[prereq] CO342;
            CO450 <-[prereq] CO351;
