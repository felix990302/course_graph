...
\begin{tikzpicture}[remember picture, overlay, font=\small]
    ...
    \PlaceCourses{CO471/co/18cm}

    \node[term, below=of S21, alias=last] (F21) {Fall 21};
    \PlaceCourses{CS370/cs/12cm, CO442/co/1.5cm, PMATH453/pm/11.5cm}

    \node[term, below=of F21, alias=last] (W22) {Winter 22};
    \PlaceCourses{CS476/cs/5cm, ENGL210F/cs/17.5cm, PMATH352/pm/1cm, PHYS233/cs/1cm}
