...
\begin{tikzpicture}[remember picture, overlay, font=\small]
    ...
    \PlaceCourses{CS762/cs/1cm, CS350/cs/3cm, PMATH347/co pm/14.5cm, PMATH450/pm/1cm}
    ...
    \PlaceCourses{CS486/cs/4cm, CO450/co/7.5cm, CO442/co/1cm, PMATH453/pm/9.5cm}

    \node[term, below=of F21, alias=last] (W22) {Winter 22};

    \node[term, below=of W22, alias=last] (S22) {Spring 22};
    \PlaceCourses{CS466/cs co/1cm, CS370/cs/6.5cm, PMATH352/pm/16cm, PHYS234/cs/1cm}
